  ...
  return (
    <div>
      <div className="w-12 h-12 rounded-2xl bg-[#4A9FFF]/10 flex items-center justify-center mb-6">
        <LogIn className="w-6 h-6 text-[#4A9FFF]" />
      </div>
        ...
        <div>
          <div className="flex justify-between items-center">
            ...
            <Link
              ...
              className="text-sm text-[#4A9FFF] hover:text-[#6BB5FF] hover:underline transition-colors"
            >
              Esqueceu a senha?
            </Link>
          </div>
      ...
      <p className="text-center text-[#718096] mt-6 font-light">
        Nao tem uma conta?{" "}
        <Link href="/cadastro" className="text-[#4A9FFF] hover:text-[#6BB5FF] hover:underline font-medium transition-colors">
          Cadastre-se
        </Link>
      </p>
    </div>
