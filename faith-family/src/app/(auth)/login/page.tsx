    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1e3a8a] to-[#1e2d6b] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold font-playfair text-[#1e3a8a]">Fé em Família</h1>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-200 hover:bg-gray-50 py-3 rounded-xl text-sm font-medium transition"
        >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Não tem conta?{" "}
          <Link href="/cadastro" className="text-[#1e3a8a] font-semibold hover:underline">
            Criar conta grátis
          </Link>
        </p>
      </div>
